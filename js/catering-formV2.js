document.addEventListener("DOMContentLoaded", function() {
  ...
  const menuData = {
    "Antipasta":[
      ...
      {name:"Mozzarella Sticks",priceFull:75,servesFull:20,perPerson:true},
      {name:"Salumi Board",priceFull:15,servesFull:1,perPerson:true},
      {name:"Bread Service",priceHalf:70,priceFull:130,servesHalf:10,servesFull:20},
      {name:"Caprese Skewers",priceHalf:50,priceFull:100,servesHalf:10,servesFull:20},
      {name:"Spinach Dip",priceFull:120,servesFull:10},
      {name:"Bruschetta Dip",priceFull:100,servesFull:10},
